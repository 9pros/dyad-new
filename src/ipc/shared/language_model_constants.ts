...
export const MODEL_OPTIONS: Record<string, ModelOption[]> = {
  ...
  qwen: [
    ...
    },
    {
      ...
      description: "Balanced coding model with excellent performance-to-speed ratio",
      maxOutputTokens: 8_192,
      contextWindow: 131_072,
      temperature: 0,
      dollarSigns: 2,
    },
    {
      ...
      description: "Fast and efficient coding model for quick tasks and prototyping",
      maxOutputTokens: 8_192,
      contextWindow: 131_072,
      temperature: 0,
      dollarSigns: 1,
    ...
    },
    {
      ...
      description: "Lightweight coding model for simple tasks and rapid iteration",
      maxOutputTokens: 8_192,
